                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner mb-4">
                              <div class="carousel-item active">
                                <div class="page-header min-vh-75 m-3 border-radius-xl" style="background-image:url('/assets/img/DITAPPS/DITAPPS1.jpeg');  background-size: 100% 100%;">
                                  <div class="container">
                               ...
                               <div class="carousel-item">
                                <div class="page-header min-vh-75 m-3 border-radius-xl" style="background-image:url('/assets/img/DITAPPS/DITAPPS2.jpeg');  background-size: 100% 100%;">
                                  <div class="container">
                                    <div class="row justify-content-center">
                                      <div class="col-lg-6 my-auto">
                                        <!--<h4 class="text-white mb-0 fadeIn1 fadeInBottom">CURSO</h4>-->
                              ...
                              <div class="carousel-item">
                                <div class="page-header min-vh-75 m-3 border-radius-xl" style="background-image:url('/assets/img/DITAPPS/DITAPPS3.jpeg');  background-size: 100% 100%;">
                                  <div class="container">
                                    <div class="row justify-content-center">
                                      <div class="col-lg-6 my-auto">
                                        <!--<h4 class="text-white mb-0 fadeIn1 fadeInBottom">CURSO</h4>-->
