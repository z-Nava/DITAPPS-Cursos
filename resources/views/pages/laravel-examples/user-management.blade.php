                        ...
                        <div class="modal-body">
                            <form action="{{ route('libros.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" required placeholder="Ingresa el titulo del libro...">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="descripcion" class="form-label">Status</label>
                                    <input type="text" class="form-control" id="status" name="status" placeholder="Ingresa la descripcion del libro" required>
                                   
                                </div>
                                <div class="mb-3">
                                    <label for="archivo" class="form-label">Rol</label>
                                    <input type="text" class="form-control" id="rol" name="rol" placeholder="Ingresa la descripcion del libro" required>
                                </div>
