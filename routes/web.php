...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/calificaciones', [GestiondeCursoController::class, 'storeCalificacion'])->name('storeCalificacion');
	...
	Route::post('/gestion-cursos/subir-archivo', [GestiondeCursoController::class, 'subirArchivo'])->name('gestion-cursos.subir-archivo');
	...
	Route::post('/salir-curso/{curso}', [GestionCursosAlumnoController::class, 'salirCurso'])->name('salirCurso');
